...
SELECT (SELECT MAX(id) + 1 from `m_charge`),'Service Charge', 'INR', 1, 8, 1, 0, 0.000000, NULL, NULL, NULL, 0, 1, 0, NULL, NULL, NULL, NULL
FROM `m_charge`
