...
import org.ideoholic.imifosx.organisation.office.data.OfficeTransactionData;
...
public class OfficeReadPlatformServiceImpl implements OfficeReadPlatformService {
    ...
    @Override
    @Cacheable(value = "offices", key = "T(org.ideoholic.imifosx.infrastructure.core.service.ThreadLocalContextUtil).getTenant().getTenantIdentifier().concat(#root.target.context.authenticatedUser().getOffice().getHierarchy()+'of')")
    ...
    @Override
    @Cacheable(value = "officesForDropdown", key = "T(org.ideoholic.imifosx.infrastructure.core.service.ThreadLocalContextUtil).getTenant().getTenantIdentifier().concat(#root.target.context.authenticatedUser().getOffice().getHierarchy()+'ofd')")
    ...
    @Override
    @Cacheable(value = "officesById", key = "T(org.ideoholic.imifosx.infrastructure.core.service.ThreadLocalContextUtil).getTenant().getTenantIdentifier().concat(#officeId)")
