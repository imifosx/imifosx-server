 ...
 * under the License.
 */
package org.ideoholic.imifosx.organisation.office.service;
...
import org.ideoholic.imifosx.organisation.office.domain.OfficeTransaction;
import org.ideoholic.imifosx.organisation.office.domain.OfficeTransactionRepository;
import org.ideoholic.imifosx.organisation.office.exception.OfficeNotFoundException;
import org.ideoholic.imifosx.organisation.office.serialization.OfficeCommandFromApiJsonDeserializer;
import org.ideoholic.imifosx.organisation.office.serialization.OfficeTransactionCommandFromApiJsonDeserializer;
...
public class OfficeWritePlatformServiceJpaRepositoryImpl implements OfficeWritePlatformService {
    ...
    @Override
    @Caching(evict = {
            @CacheEvict(value = "offices", key = "T(org.ideoholic.imifosx.infrastructure.core.service.ThreadLocalContextUtil).getTenant().getTenantIdentifier().concat(#root.target.context.authenticatedUser().getOffice().getHierarchy()+'of')"),
            @CacheEvict(value = "officesForDropdown", key = "T(org.ideoholic.imifosx.infrastructure.core.service.ThreadLocalContextUtil).getTenant().getTenantIdentifier().concat(#root.target.context.authenticatedUser().getOffice().getHierarchy()+'ofd')") })
    ...
    @Caching(evict = {
            @CacheEvict(value = "offices", key = "T(org.ideoholic.imifosx.infrastructure.core.service.ThreadLocalContextUtil).getTenant().getTenantIdentifier().concat(#root.target.context.authenticatedUser().getOffice().getHierarchy()+'of')"),
            @CacheEvict(value = "officesForDropdown", key = "T(org.ideoholic.imifosx.infrastructure.core.service.ThreadLocalContextUtil).getTenant().getTenantIdentifier().concat(#root.target.context.authenticatedUser().getOffice().getHierarchy()+'ofd')"),
            @CacheEvict(value = "officesById", key = "T(org.ideoholic.imifosx.infrastructure.core.service.ThreadLocalContextUtil).getTenant().getTenantIdentifier().concat(#officeId)") })
