...
import org.ideoholic.imifosx.organisation.teller.data.CashierData;
import org.ideoholic.imifosx.organisation.teller.data.CashierTransactionData;
import org.ideoholic.imifosx.organisation.teller.data.CashierTransactionTypeTotalsData;
import org.ideoholic.imifosx.organisation.teller.data.CashierTransactionsWithSummaryData;
import org.ideoholic.imifosx.organisation.teller.data.TellerData;
import org.ideoholic.imifosx.organisation.teller.data.TellerJournalData;
import org.ideoholic.imifosx.organisation.teller.data.TellerTransactionData;
import org.ideoholic.imifosx.organisation.teller.domain.CashierTxnType;
import org.ideoholic.imifosx.organisation.teller.domain.TellerStatus;
...
public class TellerManagementReadPlatformServiceImpl implements TellerManagementReadPlatformService {
    ...
    @Cacheable(value = "tellers", key = "T(org.ideoholic.imifosx.infrastructure.core.service.ThreadLocalContextUtil).getTenant().getTenantIdentifier().concat(#root.target.context.authenticatedUser().getOffice().getHierarchy()+'of')")
