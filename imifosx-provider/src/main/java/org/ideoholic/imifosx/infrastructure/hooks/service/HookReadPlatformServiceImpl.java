...
import org.ideoholic.imifosx.infrastructure.hooks.data.*;
import org.ideoholic.imifosx.infrastructure.hooks.domain.Hook;
import org.ideoholic.imifosx.infrastructure.hooks.domain.HookRepository;
...
public class HookReadPlatformServiceImpl implements HookReadPlatformService {
    ...
    @Override
    @Cacheable(value = "hooks", key = "T(org.ideoholic.imifosx.infrastructure.core.service.ThreadLocalContextUtil).getTenant().getTenantIdentifier().concat('HK')")
