...
import org.ideoholic.imifosx.infrastructure.codes.data.CodeData;
...
public class CodeReadPlatformServiceImpl implements CodeReadPlatformService {
    ...
    @Override
    @Cacheable(value = "codes", key = "T(org.ideoholic.imifosx.infrastructure.core.service.ThreadLocalContextUtil).getTenant().getTenantIdentifier().concat('CD')")
