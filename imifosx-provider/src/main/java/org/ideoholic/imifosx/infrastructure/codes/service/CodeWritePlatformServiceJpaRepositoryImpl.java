 ...
 * under the License.
 */
package org.ideoholic.imifosx.infrastructure.codes.service;

import java.util.Map;

import org.ideoholic.imifosx.infrastructure.codes.domain.Code;
import org.ideoholic.imifosx.infrastructure.codes.domain.CodeRepository;
import org.ideoholic.imifosx.infrastructure.codes.exception.CodeNotFoundException;
import org.ideoholic.imifosx.infrastructure.codes.exception.SystemDefinedCodeCannotBeChangedException;
import org.ideoholic.imifosx.infrastructure.codes.serialization.CodeCommandFromApiJsonDeserializer;
...
public class CodeWritePlatformServiceJpaRepositoryImpl implements CodeWritePlatformService {
    ...
    @Transactional
    @Override
    @CacheEvict(value = "codes", key = "T(org.ideoholic.imifosx.infrastructure.core.service.ThreadLocalContextUtil).getTenant().getTenantIdentifier().concat('cv')")
