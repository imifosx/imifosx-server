...
public class CodeValueReadPlatformServiceImpl implements CodeValueReadPlatformService {
    ...
    @Override
    @Cacheable(value = "code_values", key = "T(org.ideoholic.imifosx.infrastructure.core.service.ThreadLocalContextUtil).getTenant().getTenantIdentifier().concat(#codeId+'cv')")
