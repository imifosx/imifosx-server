 ...
 * under the License.
 */
package org.ideoholic.imifosx.portfolio.fund.service;
...
import org.ideoholic.imifosx.portfolio.fund.serialization.FundCommandFromApiJsonDeserializer;
...
public class FundWritePlatformServiceJpaRepositoryImpl implements FundWritePlatformService {
    ...
    @Transactional
    @Override
    @CacheEvict(value = "funds", key = "T(org.ideoholic.imifosx.infrastructure.core.service.ThreadLocalContextUtil).getTenant().getTenantIdentifier().concat('fn')")
