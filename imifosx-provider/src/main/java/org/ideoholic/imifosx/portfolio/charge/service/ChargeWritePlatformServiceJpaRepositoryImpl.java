 ...
 * under the License.
 */
package org.ideoholic.imifosx.portfolio.charge.service;
...
import org.ideoholic.imifosx.portfolio.charge.api.ChargesApiConstants;
import org.ideoholic.imifosx.portfolio.charge.domain.Charge;
import org.ideoholic.imifosx.portfolio.charge.domain.ChargeRepository;
import org.ideoholic.imifosx.portfolio.charge.exception.ChargeCannotBeDeletedException;
import org.ideoholic.imifosx.portfolio.charge.exception.ChargeCannotBeUpdatedException;
import org.ideoholic.imifosx.portfolio.charge.exception.ChargeNotFoundException;
import org.ideoholic.imifosx.portfolio.charge.serialization.ChargeDefinitionCommandFromApiJsonDeserializer;
...
public class ChargeWritePlatformServiceJpaRepositoryImpl implements ChargeWritePlatformService {
    ...
    @Transactional
    @Override
    @CacheEvict(value = "charges", key = "T(org.ideoholic.imifosx.infrastructure.core.service.ThreadLocalContextUtil).getTenant().getTenantIdentifier().concat('ch')")
