...
import org.ideoholic.imifosx.portfolio.charge.domain.ChargeAppliesTo;
...
public class ChargeReadPlatformServiceImpl implements ChargeReadPlatformService {
    ...
    @Override
    @Cacheable(value = "charges", key = "T(org.ideoholic.imifosx.infrastructure.core.service.ThreadLocalContextUtil).getTenant().getTenantIdentifier().concat('ch')")
