 ...
 * under the License.
 */
package org.ideoholic.imifosx.batch.api;
...
import org.ideoholic.imifosx.batch.serialization.BatchRequestJsonHelper;
import org.ideoholic.imifosx.batch.service.BatchApiService;
 ...
 * {@link org.ideoholic.imifosx.batch.service.BatchApiService} and de-serializes the
 * incoming JSON string to a list of
 * {@link org.ideoholic.imifosx.batch.domain .BatchRequest} type. This list is
 * forwarded to BatchApiService which finally returns a list of
 * {@link org.ideoholic.imifosx.batch.domain.BatchResponse} type which is then
