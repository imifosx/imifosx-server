...
import org.apache.fineract.infrastructure.configuration.api.GlobalConfigurationApiResource;
...
public class SavingAccountsCalculationPlatformServiceImpl implements SavingAccountsCalculationPlatformService {
    ...
    private String updateConfiguration(long configId, String apiRequestBodyAsJson) {
