...
public class ServiceChargeData extends ChargeData {
	...
	protected ServiceChargeData(final Long id, final String name, final BigDecimal amount, final CurrencyData currency,
			...
			final boolean active, final TaxGroupData taxGroup, final Collection<CurrencyData> currencyOptions,
		...
		super(id, name, amount, currency, chargeTimeType, chargeAppliesTo, chargeCalculationType, chargePaymentMode,
				penalty, active, taxGroup, currencyOptions, chargeCalculationTypeOptions, chargeAppliesToOptions,
				...
				maxCap, feeFrequency, feeFrequencyOptions, account, incomeOrLiabilityAccountOptions, taxGroupOptions, feeFrequencyOptions, feeFrequencyOptions);
	}
