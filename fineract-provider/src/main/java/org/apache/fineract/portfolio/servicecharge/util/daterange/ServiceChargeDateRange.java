...
public interface ServiceChargeDateRange {
	 ...
	 * Make sure that this is unique across all the distinctive objects among all
	 * the sub-classes. This is because the object is stored and retrieved via this
	 * Id
	 * 
	 * @return Integer
	 */
	...
	/**
	 * Gets the ending date of the give range for the current year. The calculation
	 * is done using the current system date.<br/>
	 * 
	 * @return String
	 */
	...
	/**
	 * Gets the ending date of the give range for the current year. The calculation
	 * is done using the current system date. The date needs to be formated in
	 * <i>"dd MMMM yyyy"</i> format.<br/>
	 * 
	 * @return String
	 */
	...
	/**
	 * This facilitates setting the year to the SC range. Setting a year is used to
	 * decide the year on which the calculation parameters needs to be applied
	 * 
	 * @param year
	 */
