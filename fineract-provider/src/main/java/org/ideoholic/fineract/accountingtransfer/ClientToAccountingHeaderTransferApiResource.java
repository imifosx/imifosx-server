 ...
 * under the License.
 */
package org.ideoholic.fineract.accountingtransfer;
...
@Component
@Scope("singleton")
public class ClientToAccountingHeaderTransferApiResource {

	private final ClientToAccountingHeaderTransferService transferService;

	@Autowired
	public ClientToAccountingHeaderTransferApiResource(final ClientToAccountingHeaderTransferService transferService) {
