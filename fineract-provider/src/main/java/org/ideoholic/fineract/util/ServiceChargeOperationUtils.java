...
import org.ideoholic.fineract.servicecharge.service.ServiceChargeReadPlatformService;
...
public class ServiceChargeOperationUtils implements ServiceChargeApiConstants {
	...
	/**
	 * This method checks if the given loan product is of type "Demand-Loan"<br/>
	 * By meaning of type "Demand-Loan" it means that any loan product associated
	 * with the "Serice Charge" charge, it is considered to be of this type.
	 * 
	 * @param loanProduct - LoanProduct to be verified
	 * @return boolean - If the given loan product is associated with this charge it
	...
	/**
	 * This method gets the Service Charge from the table for the current quarter.
	 * Quarter identification is done based on the current date.
	 * 
	 * @param ServiceChargeReadPlatformService
	 * @return ServiceChargeData - Service Charge data for the current quarter if
	 *         exists, null otherwise
	 */
	public static ServiceChargeData getServiceChargeForCurrentQuarter(
			final ServiceChargeReadPlatformService scChargeReadPlatformService) {
