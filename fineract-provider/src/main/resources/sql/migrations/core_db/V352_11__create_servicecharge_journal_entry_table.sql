...
CREATE TABLE IF NOT EXISTS acc_gl_servicecharge_journal_entry (
  ...
  `gl_transaction_id` bigint(20) NOT NULL,
  ...
  `mobilization_percentage` decimal(3,2) NOT NULL,
  `servicing_percentage` decimal(3,2) NOT NULL DEFAULT '0.00',
  `investment_percentage` decimal(3,2) NOT NULL DEFAULT '0.00',
  `overheads_percentage` decimal(3,2) NOT NULL DEFAULT '0.00',
  ...
  KEY `FK_acc_gl_servicecharge_journal_entry_acc_gl_journal_entry` (`gl_transaction_id`),
  ...
  CONSTRAINT `FK_acc_gl_servicecharge_journal_entry_acc_gl_journal_entry` FOREIGN KEY (`gl_transaction_id`) REFERENCES `acc_gl_journal_entry` (`id`),
